...
2) Aynı Google Sheet'i kullanarak ivme verilerini Google Sheet'inize girin. (Bu sefer 7 tane ivme veriniz olacak.) İvme-zaman grafiğini çiziniz.[grafik](https://docs.google.com/spreadsheets/d/1nsxYqjSqoLk_sCmBs74KcuOKELuIbMXkOe_rP4hK0Tk/edit#gid=0)

3) İvme'yi ne buldunuz? **İvme denklemini -1,26x-1,88 olarak buldum. Bu denklem hareket süresinde -2 ile -3 arasında. Ortalama olarak ivme x=0,4'deki değer olan -2,519.** Bu ivme değerini kullanarak 1kg'lık cisim ile yüzey arasındaki kinetik sürtünme katsayısını bulunuz. 
